...
class StreetAddress {
  ...
  factory StreetAddress.fromGeocodingResult(GeocodingResult geocodingResult) {
    ...
    return StreetAddress(
      ...
      featureName:
          search('featureName')?.long_name ?? geocodingResult.formattedAddress,
      postalCode: search('postal_code')?.long_name,
      adminArea: search('administrative_area_level_1')?.long_name,
      subAdminArea: search('administrative_area_level_2')?.long_name,
      locality: search('locality')?.long_name,
      subLocality:
          (search('sublocality') ?? search('sublocality_level_1'))?.long_name,
      thoroughfare: search('route')?.long_name,
      subThoroughfare: search('street_number')?.long_name,
    );
  }
